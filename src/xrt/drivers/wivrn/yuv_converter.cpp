...
#include <memory>
#include <stdexcept>
#include "shaders/yuv_converter.vert.h"
#include "shaders/yuv_converter.y.frag.h"
#include "shaders/yuv_converter.uv.frag.h"
    ...
    : vk(*vk)
{
	...
	res = shader_load(vk, wivrn_shaders_yuv_converter_vert, sizeof(wivrn_shaders_yuv_converter_vert), &vert);
	vk_check_throw("shader_load", res);

	res = shader_load(vk, wivrn_shaders_yuv_converter_y_frag, sizeof(wivrn_shaders_yuv_converter_y_frag), &y.frag);
	vk_check_throw("shader_load", res);
	res =
	    shader_load(vk, wivrn_shaders_yuv_converter_uv_frag, sizeof(wivrn_shaders_yuv_converter_uv_frag), &uv.frag);
	vk_check_throw("shader_load", res);
