 ...
 *
 * Commandline:
 *    --api='egl=1.2' --extensions='EGL_ANDROID_image_native_buffer,EGL_KHR_platform_android' c
 *
 * Online:
 *    http://glad.sh/#api=egl%3D1.2&extensions=EGL_ANDROID_image_native_buffer%2CEGL_KHR_platform_android&generator=c&options=
 *
 */
