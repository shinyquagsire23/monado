...
static int sem_init(sem_t *psem, int flags, unsigned count)
{
    bosal_sem_t *pnewsem;
    int result;
...
static int sem_destroy(sem_t *psem)
{
    bosal_sem_t *poldsem;
...
static int sem_post(sem_t *psem)
{
     bosal_sem_t *pxsem;
    int result, xresult;
...
static int sem_trywait(sem_t *psem)
{
    bosal_sem_t *pxsem;
    int result, xresult;
...
static int sem_wait(sem_t *psem)
{
    bosal_sem_t *pxsem;
    int result, xresult;
...
static int sem_timedwait(sem_t *psem, const struct timespec *abstim)
{
    bosal_sem_t *pxsem;
    int result, xresult;
