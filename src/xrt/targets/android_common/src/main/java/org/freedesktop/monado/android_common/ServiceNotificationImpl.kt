...
class ServiceNotificationImpl @Inject constructor() : IServiceNotification {
    ...
    @Inject lateinit var uiProvider: UiProvider

    @Inject lateinit var nameAndLogoProvider: NameAndLogoProvider

    /**
     * Start creating a Notification.Builder in a version-compatible way, including our notification
    ...
    override fun buildNotification(
        ...
        uiProvider.getNotificationIcon()?.let { icon: Icon -> builder.setSmallIcon(icon) }
